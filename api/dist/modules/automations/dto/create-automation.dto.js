...
exports.CreateAutomationDto = exports.ActionDto = exports.ConditionDto = exports.TriggerDto = void 0;
...
], TriggerDto.prototype, "params", void 0);
class ConditionDto {
    field;
    operator;
    value;
...
__decorate([
    ...
    (0, class_validator_1.IsOptional)(),
    __metadata("design:type", String)
], CreateAutomationDto.prototype, "pipelineId", void 0);
__decorate([
    (0, class_validator_1.IsObject)(),
