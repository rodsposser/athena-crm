...
export declare class LeadsController {
    ...
    create(orgId: string, user: JwtUser, pipelineId: string, dto: CreateLeadDto): Promise<{
        company: {
            name: string;
            id: string;
            createdAt: Date;
    ...
    findByPipeline(orgId: string, pipelineId: string, statusId?: string, assigneeId?: string, search?: string, limit?: string, cursor?: string): Promise<({
        company: {
            name: string;
            id: string;
        } | null;
